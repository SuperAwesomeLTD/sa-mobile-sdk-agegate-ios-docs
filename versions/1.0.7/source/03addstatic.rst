...
You can download the latest `SAAgeGateSDK-<sdk_version>.iOS.lib.zip <https://github.com/SuperAwesomeLTD/sa-sdk-build-repo/blob/master/package/ag_ios/<sdk_version>/SAAgeGateSDK-<sdk_version>.iOS.lib.zip?raw=true>`_ file - which contains the **libSAAgeGateSDK.a** and
